...
import { Package, Search, Plus, Edit, Trash2, DollarSign, AlertTriangle, ArrowUpDown, Eye } from "lucide-react"
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button
          ...
          className="bg-emerald-600 hover:bg-emerald-700 text-white transition-all duration-300 shadow-lg hover:shadow-xl"
        >
      ...
      <Card className="overflow-hidden border border-gray-200 shadow-md">
        <CardHeader className="bg-gradient-to-r from-emerald-50 to-teal-50 border-b border-gray-200">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <CardTitle className="text-emerald-800">Lista de Productos</CardTitle>
            <div className="relative w-full sm:w-64">
              <Search className="absolute left-2.5 top-2.5 h-4 w-4 text-gray-500" />
              <Input
                type="search"
                placeholder="Buscar productos..."
                className="pl-8 bg-white border-gray-300 focus:border-emerald-500 focus:ring focus:ring-emerald-200 focus:ring-opacity-50"
                value={searchTerm}
        ...
        <CardContent className="p-0">
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center h-64 text-center p-4">
              ...
              <p className="text-gray-500 mt-1">No se encontraron productos que coincidan con tu búsqueda.</p>
            </div>
          ) : (
                ...
                <TableBody>
                  {filteredProducts.map((product) => (
                    <TableRow key={product.id} className="hover:bg-gray-50 transition-colors duration-150">
                      ...
                      <TableCell>
                        <Badge variant="outline" className={`${getStockStatusColor(product.stock)} font-medium`}>
                        ...
                        <div className="flex justify-end gap-2">
                          ...
                          <AlertDialog>
                            ...
                            <AlertDialogContent className="border-red-100">
                              <AlertDialogHeader>
                                <AlertDialogTitle className="text-red-600">¿Eliminar producto?</AlertDialogTitle>
                                <AlertDialogDescription>
